...
//        // Set min. board offset
//        boardEdges = new Vector4(start.x - offset, start.y - offset, boardEdges.z, boardEdges.w);
...
//        // Set min. board offset
//        boardEdges = new Vector4(boardEdges.x, boardEdges.y, start.x + offset, start.y + offset);
